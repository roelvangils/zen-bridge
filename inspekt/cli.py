#!/usr/bin/env python3
"""
Inspekt CLI - Execute JavaScript in your browser from the command line.
"""
...
from . import config as inspekt_config
...
def eval(code, file, timeout, format, url, title):
    ...
    Examples:
        ...
        inspekt eval "alert('Hello from CLI!')"
...
def type_text(text, selector, speed):
    ...
    Examples:
        ...
        inspekt type "test@example.com" --selector "input[type=email]"
        inspekt type "Slow typing" --speed 5
        inspekt paste "Instant text"
    """
    client = BridgeClient()
    ...
    typing_config = inspekt_config.get_typing_config()
    typo_rate = typing_config['human-like-typo-rate']

    # Replace placeholders with properly escaped text using JSON encoding
    ...
    code = code.replace("CLEAR_PLACEHOLDER", "false")
